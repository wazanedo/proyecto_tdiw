<div class="grid-container">
    <?php foreach($resultado_categorias as $categoria): ?>
        <div id="categoria" class="categoria<?php echo $categoria['category_id']?>">
            <a class="a_categoria" style="text-decoration:none;" id="<?php echo $categoria['category_id']?>" href="/index.php?action=llistaProd&ProdId=<?php echo $categoria['category_id']?>&categoria=<?php echo $categoria['name']?>"><h2 id="class_title_h2" class="title_categoria"><?php echo (htmlentities($categoria['name'], ENT_QUOTES | ENT_HTML5, 'UTF-8')); ?></h2>
